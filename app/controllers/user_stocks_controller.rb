class UserStocksController < ApplicationController
  ...
  def create
    if prams[:stock_id].present?
      @user_stocks = UserStock.new(stock_id: params[:stock_id], user: current_user)
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my-portfolio_path, notice: "Stock #{@user_stock.stock.ticker} stock was sucessfully added" }
